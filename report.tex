...
Because our outputs are real numbers, we use a squared error loss to evaluate the training error and the test error of our model.  (List all the best models from each of the above methods. )(Talk about correlation betwen Nfat5 and other variables in the model)
