...
\begin{figure}[H]
	...
	\includegraphics[scale=1]{best_subsets}
	\centering
...
\null\\
In the future we can also incorporate more information about the specific genes to force them in model even if they're highly correlated.  
\end{document}
